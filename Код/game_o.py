...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.addItem("")  # Добавлено для обновления
        ...
        self.move_up_button.setIconSize(QtCore.QSize(40, 40))
        ...
        self.move_left_button.setIconSize(QtCore.QSize(40, 40))
        ...
        self.move_right_button.setIconSize(QtCore.QSize(40, 40))
        ...
        self.move_down_button.setIconSize(QtCore.QSize(40, 40))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(3, _translate("MainWindow", "Refresh"))  # Добавлено для обновления
    ...
    def handle_combobox(self, text):
        if text == "Help":
            ...
            self.init_game(board_size=6)
        elif text == "3x5":
            self.init_game(board_size=(3, 5))
        elif text == "Refresh":  
